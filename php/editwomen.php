<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET')
    {
        ...
        $sql = "SELECT * FROM womenitem WHERE id = $id";
        ...
        do {
            ...
            $sql = "UPDATE womenitem SET name = '$name', price = '$price' WHERE id = $id";
    ...
    <div style="max-width: 600px; margin: 40px auto; background-color: white; padding: 20px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); border-radius: 8px;">
        ...
        <form method="post" action="">
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                <a href="womenwear.php" style="background-color: #6c757d; color: white; padding: 10px 20px; border: none; border-radius: 4px; text-decoration: none; text-align: center;">Cancel</a>
            </div>
        </form>
    </div>
</body>
